...
export const NEON_PRESETS = {
  ...
  gradient: {
    text: "linear-gradient(90deg, #ff00ff, #00ffff)",
    border: "#ff00ff",
    name: "Gradient Neon",
  },
...
interface NeonTextProps {
  ...
  preset?: NeonPreset;
  intensity?: number;
  inline?: boolean; // cuando true: sin min-h-screen ni bg-background
}
    ...
    <div
      className={cn(
        inline
          ...
          : "min-h-screen bg-background flex items-center justify-center font-mono",
        className,
      )}
      style={
        {
...
export function NeonColorPicker({
  ...
  console.log(
    "[v0] NeonColorPicker render - isExpanded:",
    isExpanded,
    "intensity:",
    intensity,
  );
  ...
  duration-200 mb-2"
      ...
      >
        <div className="flex items-center gap-2">
          <div
            ...
            style={{ backgroundColor: NEON_PRESETS[currentPreset].text }}
          />
      ...
      <div
        className={cn(
          ...
          isExpanded
            ? "p-4 pb-6 opacity-100 max-h-[520px] w-96"
            : "p-0 opacity-0 max-h-0 w-0", // 改为 w-96
        )}
      >
        <h3 className="text-white/90 text-xs font-light mb-3 tracking-wide">
          Gas Type
        </h3>
        ...
        <div className="space-y-3 pt-3 border-t border-white/20">
          <div className="flex items-center justify-between">
            <label className="text-white/90 text-sm font-light tracking-wide">
              Intensity
            </label>
